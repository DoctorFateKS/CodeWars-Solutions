...
// The push method is a built-in function in JavaScript that adds one or more elements to the end of an 
// array. It is commonly used when you want to dynamically add elements to an array without needing to 
// manage the array's indices manually.
